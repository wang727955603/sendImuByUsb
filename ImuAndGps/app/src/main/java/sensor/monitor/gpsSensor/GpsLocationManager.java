...
public class GpsLocationManager extends BaseLocationManager {
    ...
    public void onLocationChanged(Location location) {
        Log.i("gps","onLocationChanged location="+location.toString());
    ...
    public void onProviderDisabled(String provider) {
        Log.i("gps","onProviderDisabled provider="+provider);
    ...
    public void onProviderEnabled(String provider) {
        Log.i("gps","onProviderEnabled provider="+provider);
        if (this.listener != null) {
    ...
    public void onStatusChanged(String provider, int status, Bundle extras) {
        Log.i("gps","onStatusChanged provider="+provider);
        if (this.listener != null)
